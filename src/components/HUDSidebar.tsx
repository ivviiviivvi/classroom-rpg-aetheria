...
import { House, User, BookOpen, Target, Sword, Brain, Shield, GraduationCap, ArrowsClockwise, Palette, Trophy, ChalkboardTeacher, Sparkle, ChartBar, Flask } from '@phosphor-icons/react'
      ...
      <nav className="space-y-2 flex-1">
        ...
        <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
          <Button
            ...
            className="w-full justify-start gap-3"
            onClick={() => onNavigate('ingestion-zone')}
          >
